...
type AuthFormPageSkeletonProps = {
  variant: "login" | "signup" | "recover";
};

export function AuthFormPageSkeleton({ variant }: AuthFormPageSkeletonProps) {
  const fieldCount = variant === "login" ? 2 : variant === "signup" ? 4 : 4;
