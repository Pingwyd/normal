...
export function HeroSection() {
  ...
  return (
    <section className="px-4 pb-14 pt-[78px] text-center sm:px-0">
      ...
      <h1 className="mx-auto mt-[18px] max-w-[680px] font-display text-[32px] font-medium leading-[1.18] tracking-tight text-foreground sm:text-[44px]">
        Is it normal to{" "}
        <span className="border-b-[3px] border-accent pb-0.5">{typedText}</span>
        <span
